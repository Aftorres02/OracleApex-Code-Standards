...
[`.claude/rules/`](../../.claude/rules/) and are always loaded into Claude
Code's context via the root [`CLAUDE.md`](../../CLAUDE.md) index. They're
also the reference for human code review. See
[`.claude/STRUCTURE.md`](../../.claude/STRUCTURE.md) for what each rule
file covers.

Ready-to-copy code templates live in [`docs/coding-standards/templates/`](../coding-standards/templates/).
