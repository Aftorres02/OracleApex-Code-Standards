...
| `skills/` | Multi-step process guides — versioned APEX migrations, hand-authoring APEXlang apps, investigating a slow refresh/query with real execution plans. (Release process + full project scaffold now live in a separate repo — see `rules/repo-structure.md`.) |
